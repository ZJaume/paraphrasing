...
def greedy_score(fileone, filetwo, embeddings):
    #f1 = open(fileone, 'r')
    #f2 = open(filetwo, 'r')
    r1 = fileone #f1.readlines()
    r2 = filetwo #f2.readlines()
    w2v = KeyedVectors.load_word2vec_format(embeddings, binary=embeddings.endswith('.bin'))
